...
public class GeoIPServiceLocator extends org.apache.axis.client.Service implements as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPService {
 ...
 */
    ...
    public as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap_PortType getGeoIPServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap_BindingStub _stub = new as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap_BindingStub(portAddress, this);
    ...
    public as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap_PortType getGeoIPServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap12Stub _stub = new as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap_BindingStub _stub = new as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap_BindingStub(new java.net.URL(GeoIPServiceSoap_address), this);
                _stub.setPortName(getGeoIPServiceSoapWSDDServiceName());
                return _stub;
            }
            if (as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap12Stub _stub = new as.ff.nl.a3mpapi.Rest.ipsoapservice.GeoIPServiceSoap12Stub(new java.net.URL(GeoIPServiceSoap12_address), this);
                _stub.setPortName(getGeoIPServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
